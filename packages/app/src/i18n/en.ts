export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MarsbotCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MarsbotCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MarsbotCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MarsbotCode.",
  ...
  "dialog.server.description": "Switch which MarsbotCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "MarsbotCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking MarsbotCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking MarsbotCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating MarsbotCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating MarsbotCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update MarsbotCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update MarsbotCode",
  "wsl.onboarding.opencodeReadyIn": "MarsbotCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MarsbotCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install MarsbotCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install MarsbotCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MarsbotCode.",
  ...
  "toast.update.description": "A new version of MarsbotCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MarsbotCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MarsbotCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MarsbotCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "MarsbotCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the MarsbotCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MarsbotCode",
  ...
  "settings.general.row.appearance.description": "Customise how MarsbotCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MarsbotCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MarsbotCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MarsbotCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MarsbotCode.",
